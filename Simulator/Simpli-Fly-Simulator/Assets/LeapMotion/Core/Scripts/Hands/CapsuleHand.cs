  ...
  public class CapsuleHand : HandModelBase {
    ...
    public override void UpdateHand() {
      ...
      Vector3 palmPosition = _hand.PalmPosition.ToVector3();
            ...
            Debug.Log("pp" + palmPosition);
            Debug.Log("d" + _hand.Direction.Roll);
            Debug.Log("d" + _hand.Direction.Pitch);
            Debug.Log("d" + _hand.Direction.Yaw);
            droneObject.transform.eulerAngles = new Vector3(Mathf.Rad2Deg * _hand.Direction.Roll, Mathf.Rad2Deg * _hand.Direction.Pitch, Mathf.Rad2Deg * _hand.Direction.Yaw);
            Debug.Log("pn" + _hand.PalmNormal);
